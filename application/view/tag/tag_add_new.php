...
<h1>
    <?php echo TAG_TITLE_ADD_NEW; ?>
</h1>
<div id="message_notice">
    <?php $this->renderFeedbackMessages(); ?>
</div>
<form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . TAG_CP_ADD_NEW; ?>">
        ...
        <tbody>
            ...
            <tr class="tag-parent-wrap"><th><label for="parent"><?php echo TAG_TITLE_PARENT; ?></label></th>
                <td>
                    ...
                    <span class="description"><?php echo TAG_DESC_PARENT; ?></span>
                </td>
            </tr>
    ...
    <p class="submit"><input type="submit" value="<?php echo TAG_TITLE_ADD_NEW; ?>" class="button button-primary" id="submit" name="submit"></p>
</form>
<script>
    window.scrollTo(0, 0);
    ...
    jQuery("#form-your-profile").submit(function (e) {
        ...
        if (confirm('<?php echo TAG_CONFIRM_ADD_NEW; ?>' + name + '<?php echo CONFIRM_EDIT_INFO_CANCEL_OK; ?>')) {
