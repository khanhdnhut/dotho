...
<h1>
    <?php echo USER_TITLE_NEW_USER; ?>
</h1>
<div id="message_notice">
    <?php $this->renderFeedbackMessages(); ?>
</div>
<form id="form-your-profile" novalidate="novalidate"  method="POST" enctype="multipart/form-data" action="<?php echo URL . USER_CP_ADD_NEW; ?>">
    ...
    <table class="form-table">
        <tbody>
            <tr class="user-user-login-wrap">
                <th>
                    <label for="user_login"><?php echo USER_TITLE_USERNAME; ?> <span style="color: red;" class="description"><?php echo TITLE_REQUIRED; ?></span></label>
                </th>
                <td>
    ...
    <table class="form-table">
        <tbody>
            <tr class="user-pass1-wrap" id="password">
                <th>
                    <label for="pass1-text"><?php echo USER_TITLE_PASSWORD; ?> <span style="color: red;" class="description"><?php echo TITLE_REQUIRED; ?></span></label>
                </th>
                <td>
    ...
    <p class="submit"><input type="submit" value="<?php echo USER_TITLE_NEW_USER; ?>" class="button button-primary" id="submit" name="submit"></p>
</form>
<script>
    window.scrollTo(0, 0);
    ...
    function validateFormAddNewUser() {
        if (jQuery('#form-your-profile input[name="user_login"]').val() == "") {
            noticeError("<?php echo USER_ERROR_USERNAME_EMPTY; ?>");
            return false;
        }
        ...
        if (jQuery('#form-your-profile input[name="pass1-text"]').val() == "" ||
            ...
            noticeError("<?php echo USER_ERROR_PASSWORD_IS_EMPTY; ?>");
            return false;
        }
        return true;
    }
